# src/arche_api/adapters/routers/edgar_router.py
# Copyright (c)
...
from arche_api.adapters.presenters.edgar_overrides_presenter import (
    present_statement_override_trace,
)
from arche_api.adapters.presenters.edgar_presenter import EdgarPresenter
from arche_api.adapters.routers.base_router import BaseRouter, PageParams
...
from arche_api.application.schemas.dto.edgar import EdgarFilingDTO
...
from arche_api.domain.services.derived_metrics_engine import DERIVED_METRIC_SPECS
