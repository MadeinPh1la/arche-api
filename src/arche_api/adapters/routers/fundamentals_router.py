# src/arche_api/adapters/routers/fundamentals_router.py
# Copyright (c)
...
from arche_api.adapters.presenters.edgar_dq_presenter import present_statement_dq_overlay
...
from arche_api.adapters.schemas.http.edgar_dq_schemas import StatementDQOverlayHTTP
...
from arche_api.adapters.schemas.http.fundamentals import (
...
from arche_api.application.use_cases.statements.get_normalized_statement import (
