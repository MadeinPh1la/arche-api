# src/arche_api/adapters/routers/mcp_router.py
# Copyright (c) Arche.
# SPDX-License-Identifier: MIT
"""MCP HTTP Router (Adapters Layer).

Purpose:
    Expose the Arche MCP server over HTTP as a simple, typed endpoint:
...
`arche_api.mcp.server`. It does not contain business logic.
"""
...
from arche_api.mcp.server import MCPRequest, MCPResponse, MCPServer, UnknownMCPMethodError
