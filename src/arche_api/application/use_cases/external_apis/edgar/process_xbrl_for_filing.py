# src/arche_api/application/use_cases/external_apis/edgar/process_xbrl_for_filing.py
# Copyright (c)
...
from arche_api.domain.entities.xbrl_document import XBRLContext, XBRLDocument
