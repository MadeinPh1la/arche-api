# src/arche_api/application/use_cases/statements/get_statement_override_trace.py
# Copyright (c) Arche.
...
from arche_api.domain.services.edgar_normalization import EdgarFact, NormalizationContext
...
def _get_xbrl_mapping_overrides_repository(
    ...
    module = import_module(
        "arche_api.adapters.repositories.xbrl_mapping_overrides_repository",
    )
