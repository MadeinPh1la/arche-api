# src/arche_api/infrastructure/observability/metrics_market_data.py
# Copyright (c)
...
* ``arche_market_data_gateway_latency_seconds`` (Histogram)
* ``arche_market_data_errors_total`` (Counter)
* ``arche_market_data_cache_hits_total`` (Counter)
* ``arche_market_data_cache_misses_total`` (Counter)
* ``arche_usecase_historical_quotes_latency_seconds`` (Histogram)
* ``arche_market_data_304_total`` (Counter)
* ``arche_market_data_breaker_events_total`` (Counter)
* ``arche_market_data_http_status_total`` (Counter)
* ``arche_market_data_response_bytes`` (Histogram)
* ``arche_market_data_retries_total`` (Counter)
...
def _get_or_create_histogram(
    ...
    Args:
        name: Metric name (e.g. ``"arche_market_data_gateway_latency_seconds"``).
...
market_data_gateway_latency_seconds: Histogram = _get_or_create_histogram(
    "arche_market_data_gateway_latency_seconds",
...
market_data_errors_total: Counter = _get_or_create_counter(
    "arche_market_data_errors_total",
...
market_data_breaker_events_total: Counter = _get_or_create_counter(
    "arche_market_data_breaker_events_total",
...
market_data_http_status_total: Counter = _get_or_create_counter(
    "arche_market_data_http_status_total",
...
def observe_upstream_request(
    ...
    * a latency sample in
      :data:`arche_market_data_gateway_latency_seconds`, and
    * optionally an error increment in
      :data:`arche_market_data_errors_total` when
