# src/arche_api/config/settings.py
# Copyright (c) Arche.
# SPDX-License-Identifier: MIT
"""Arche Configuration (Pydantic Settings, v2)

Summary:
    Typed, validated application configuration for the Arche API. This
...
class Settings(BaseSettings):
    """Typed application configuration for Arche.
    ...
    api_base_url: AnyHttpUrl | None = Field(
        default=None,
        description=(
            "Public base URL for the Arche HTTP API (used in links, docs, "
