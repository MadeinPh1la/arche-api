# src/stacklion_api/adapters/repositories/xbrl_mapping_overrides_repository.py
...
from stacklion_api.infrastructure.database.models.ref import EdgarXBRLMappingOverride
