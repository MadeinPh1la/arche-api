# src/stacklion_api/application/use_cases/statements/process_xbrl_for_filing.py
...
Purpose:
    ...
    XBRL-processing pipeline under the external-API oriented namespace:
        ...
        stacklion_api.application.use_cases.external_apis.edgar.process_xbrl_for_filing
