...
_REQUEST_ID_CTX: ContextVar[str | None] = ContextVar("stacklion_request_id", default=None)
_TRACE_ID_CTX: ContextVar[str | None] = ContextVar("stacklion_trace_id", default=None)
