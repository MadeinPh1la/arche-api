...
class StacklionHTTPError(Exception):
    ...
    Attributes:
        ...
        error_code: Stacklion HTTP error code from the ErrorEnvelope, if present.
...
class StacklionHTTPClient:
    ...
    async def _request(
        ...
        Returns:
            Parsed StacklionHTTPResponse with status, headers, and JSON body.
    ...
    async def get_live_quotes(self, tickers: list[str]) -> StacklionHTTPResponse:
        ...
        Returns:
            StacklionHTTPResponse containing the quote payload on success.

        Raises:
            StacklionHTTPError: If the HTTP request fails or returns an error status.
        """
    ...
    async def get_historical_quotes(
        ...
        *,
        ...
        Returns:
            StacklionHTTPResponse containing the historical quote payload.
    ...
    async def get_health(self) -> StacklionHTTPResponse:
        ...
        Returns:
            StacklionHTTPResponse representing the health payload.
