...
✅ Read, study, and modify the code
✅ Use it internally for research, testing, or proof-of-concept projects
✅ Submit pull requests or issues
✅ Build client SDKs or tooling integrations (MIT-licensed parts)
...
For production or commercial use, contact:
...
- Organization name
- Intended use case (e.g., internal analytics, API platform, SaaS integration)
- Expected deployment scale (dev/staging/prod)

Our team will provide a **custom license key** or **enterprise agreement** with
appropriate service tiers, SLAs, and pricing.

---

## Change License Timeline

On **October 15, 2028**, this repository’s BSL grant automatically converts to
the **Apache 2.0 License**.
After that date, anyone may use, modify, or deploy the software under Apache 2.0
terms.

---

## SDKs, Schemas, and Documentation
...
For questions, partnership requests, or enterprise pricing, contact:
**partnerships@northernlionlabs.com**
